            ...
            <section className="relative z-10 overflow-hidden">
                        ...
                        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
                            <div>
                                ...
                                <div className="mb-5 inline-flex items-center gap-2.5 rounded-full border border-border/50 bg-white px-3 py-1.5 shadow-smooth">
                                    <Image src="/university-of-maryland-seeklogo.png" alt="University of Washington" width={90} height={18} className="rounded-sm" />
                ...
                <div className="relative z-10 mx-auto max-w-[1280px] px-6 md:px-12">
                    <div className="grid gap-8 border-t border-border/40 py-10 md:grid-cols-4">
                        ...
                        <DetailRow label="Team" value="Jiho, Hitarthi, Mansi, Saumya, Hansika" />
                        <DetailRow label="Timeline" value="Spring 2025" />
                        <DetailRow label="Institution" value="University of Washington, iSchool" />
                    </div>
                </div>
            </section>
                ...
                <div className="mx-auto max-w-[1000px] px-6 md:px-12">
                    ...
                    <Fade><div className="overflow-x-auto rounded-xl border border-border/50 bg-white">
                        <table className="w-full text-left font-mono text-xs">
                            ...
                            <tbody>
                                {[["A01", "Teaching + Advisor Faculty", "Hitarthi", "Mansi"], ["B01", "Teaching + Director Faculty", "Saumya", "Jiho"], ["C01", "Teaching Faculty (Remote)", "Mansi", "Saumya"], ["D01", "Director Level Faculty", "Saumya", "Hitarthi"], ["F01", "Research + Teaching Faculty", "Jiho", "Hitarthi"], ["G01", "Teaching Faculty", "Hansika", "Saumya"], ["H01", "Teaching Faculty", "Hansika", "Jiho"]].map(([id, role, int_, note]) => (<tr key={id} className="border-b border-border/20 last:border-0"><td className="px-5 py-3 font-medium text-primary">{id}</td><td className="px-5 py-3 text-text-secondary">{role}</td><td className="px-5 py-3 text-text-secondary">{int_}</td><td className="px-5 py-3 text-text-secondary">{note}</td></tr>))}
                            </tbody>
                        </table>
                    </div></Fade>
            ...
            <section id="wf-outcome" className="relative z-10 py-24 md:py-32">
                <div className="mx-auto max-w-[1000px] px-6 md:px-12">
                    ...
                    <MediaPop><div className="mt-20">
                        <p className="mb-5 text-center font-mono text-[10px] uppercase tracking-widest text-text-muted">University of Washington - College of Information Studies</p>
                        <div className="relative aspect-[16/7] w-full overflow-hidden rounded-2xl border border-border grayscale transition-all duration-700 hover:grayscale-0">
                            <Image src="/Faculty Dashboard/UniversityofMaryland ischool.jpeg" alt="University of Washington iSchool" fill className="object-cover" />
                        </div>
                    </div></MediaPop>
                </div>
            </section>
