      ...
      <section className="relative z-10 overflow-hidden bg-[#FAFAFA]">
        ...
        <div className="mx-auto max-w-[1280px] px-6 pt-28 pb-10 md:px-12 md:pt-32">
          ...
          <p className="mt-5 max-w-2xl font-mono text-sm leading-relaxed text-text-secondary">
            Graphic designer, video director, and content strategist for the University of Washington's competitive esports program. From game day graphics to a green-screen Valorant intro film built from scratch.
          </p>
        </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_260px] lg:items-start">
            ...
            <div className="space-y-6 lg:pt-2">
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-5">
                ...
                <DetailRow label="Organisation" value="Terps Esports, University of Washington" />
        ...
        <div className="mx-auto max-w-[1280px] px-6 md:px-12">
          ...
          <Fade>
            ...
            <p className="mt-3 font-mono text-[10px] text-white/30">
              Written, directed, and edited by Jiho Kim · Adobe Premiere Pro + After Effects · Chroma key compositing
            </p>
          </Fade>
        </div>
      </section>
