...
const XYLEM_CONTEXT = `You are an AI assistant for Jiho Kim's portfolio case study: NASA Harvest, Xylem Institute.

Jiho joined the Xylem Lab at UMD (NASA Harvest-affiliated, led by Professor Catherine Nakalembe) in November 2025. The lab translates satellite-derived crop data into policy-ready intelligence for food security agencies across East and Southern Africa.
...
function ProjectSmartBar() {
  ...
  async function send(text: string) {
    ...
    try {
      ...
      const raw = data.content || "I can help answer that based on Jiho's project details.";
    ...
    <div className="relative min-h-screen bg-[#FAFAFA] text-text selection:bg-primary/20">
          ...
          <Fade>
            <div className="grid gap-12 md:grid-cols-2 lg:gap-20">
              <div className="space-y-5">
                ...
                <p className="font-mono text-base leading-relaxed text-text-secondary">
                  The science was rigorous. The communication layer wasn't. When Jiho joined in November 2025, the lab had <strong className="font-medium text-text">no public-facing website, no design system, no brand standards, and no automated way to deliver outputs to non-technical stakeholders</strong>. Analysts were manually assembling bulletin reports that took days. There was no training infrastructure for the RFBS workshop coming in weeks.
                </p>
                <p className="font-mono text-base leading-relaxed text-text-secondary">
          ...
          <Fade>
            <div className="grid gap-12 md:grid-cols-2 lg:gap-20 mb-16">
              <div className="space-y-5">
                ...
                <p className="font-mono text-base leading-relaxed text-text-secondary">
                  Jiho was on the ground in Nairobi as part of the lab team, supporting both the technical training sessions and ensuring the design materials, training sites, slides, reference documents, worked as intended under live conditions.
                </p>
              </div>
      ...
      <WhyThisMatters
        ...
        points={[
          ...
          "Successfully delivered training for a system (YieldWatch + Auto-Pilot) that Jiho also helped build, showing full end-to-end ownership.",
      ...
      <WhyThisMatters
        id="recruiter-lens-6"
        headline="Building an AI pipeline end-to-end, from prompt design to HTML rendering to ZIP packaging, demonstrates that Jiho operates across the full product stack, not just the UI."
        points={[
