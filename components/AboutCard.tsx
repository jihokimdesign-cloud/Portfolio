      ...
      <div className="relative flex flex-col items-center gap-12 md:flex-row md:items-start md:gap-16">
        ...
        >
          ...
          <p className="mt-7 text-[15.5px] leading-[1.85] text-text-secondary">
            I started in fashion design and museology in Seoul, then made a sharp turn into tech when I realized the most interesting design problems live at the intersection of humans and complex systems. That shift brought me to the <strong className="text-text">University of Washington</strong> for a Master&apos;s in HCI+Design.
          </p>
          <p className="mt-4 text-[15.5px] leading-[1.85] text-text-secondary">
            Since then I&apos;ve designed AI agent experiences at a <strong className="text-text">stealth startup</strong>, shipped emotional continuity features at <strong className="text-text">Lepal.ai</strong>, built AR-based onboarding at <strong className="text-text">TAP3D</strong>, and architected a zero-defect design system for <strong className="text-text">Project Sidewalk</strong> that mapped 12,000+ accessibility labels.
          </p>
          <p className="mt-4 text-[15.5px] leading-[1.85] text-text-secondary">
            I bridge design and engineering, prototyping with Cursor AI and Claude Code, building with GSAP and React, and always grounding decisions in user research. I also explore AR and AI in the browser, from hand-tracking bloom gardens to finger-spell recognition.
          </p>
