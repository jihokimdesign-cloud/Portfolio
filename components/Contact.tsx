...
/* ── Data ─────────────────────────────────────────────────────────────── */
const RECEIPT_ITEMS = [
  { service: "AI/Agent UX",        projects: "Stealth Startup, Lepal.ai, Cheffy"              },
  { service: "Product Design",     projects: "TAP3D, Lepal.ai, Cheffy, Project Sidewalk"      },
  { service: "Interaction Design", projects: "Cheffy, TAP3D, Stealth Startup"                 },
  { service: "Design Systems",     projects: "Project Sidewalk, Stealth Startup"               },
  { service: "AR/VR Prototyping",  projects: "TAP3D, CookAR"                                  },
  { service: "User Research",      projects: "Lepal.ai, TAP3D, Project Sidewalk"               },
];

const SOCIALS = [
  { label: "LinkedIn", href: SITE.linkedin },
  { label: "Medium",   href: "https://medium.com/@arproj.ject.t/how-to-design-xr-shopping-apps-64b330f7eba9" },
];

const NOT_YET = [
  { label: "Try the AI Lab demos",       href: "#hero-section", ext: false },
  { label: "Browse the Work",            href: "#work",         ext: false },
  { label: "Read the 5min Guide",        href: "/about-legacy.html", ext: false },
];
        ...
        >
          <div style={{ background: "white", padding: "24px 22px 18px" }}>
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              {/* Checked items */}
              {[
                "Visited Jiho's Design Space",
                "Explored AI Agent Case Studies",
                "Discovered AR/VR Prototypes",
              ].map((item) => (
