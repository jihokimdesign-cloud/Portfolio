...
const SLOTS: SlotItem[] = [
  ...
  // ── MICROSOFT BADGE ─────────────────────────────────────────────────
  { file: "UIST_Logo.png",     left: 7,  top: 8,  depth: 0.13, rotation: 6,  opacity: 1,    anchor: "tl" },
];
      ...
      >
        ...
        >
          ...
          <div style={{ position: "relative", width: 28, height: 36, imageRendering: "pixelated", flexShrink: 0 }}>
            {/* Long hair */}
            <div style={{ position:"absolute", top:0, left:2, width:24, height:8, background:"#2c1810", borderRadius:2 }} />
            <div style={{ position:"absolute", top:2, left:0, width:4, height:18, background:"#2c1810" }} />
            <div style={{ position:"absolute", top:2, left:24, width:4, height:18, background:"#2c1810" }} />
            {/* Head */}
            <div style={{ position:"absolute", top:4, left:4, width:20, height:14, background:"#F0C8A0" }} />
            {/* Bangs */}
            <div style={{ position:"absolute", top:4, left:4, width:20, height:4, background:"#2c1810" }} />
            {/* Eyes */}
            <div style={{ position:"absolute", top:10, left:8, width:3, height:3, background:"#1a1a1a" }} />
            <div style={{ position:"absolute", top:10, left:17, width:3, height:3, background:"#1a1a1a" }} />
            {/* Eye shines */}
            <div style={{ position:"absolute", top:10, left:9, width:1, height:1, background:"#fff" }} />
            <div style={{ position:"absolute", top:10, left:18, width:1, height:1, background:"#fff" }} />
            {/* Blush */}
            <div style={{ position:"absolute", top:13, left:6, width:3, height:2, background:"#F4A0A0", borderRadius:1 }} />
            <div style={{ position:"absolute", top:13, left:19, width:3, height:2, background:"#F4A0A0", borderRadius:1 }} />
            {/* Smile */}
            <div style={{ position:"absolute", top:14, left:10, width:8, height:2, background:"#c07850", borderRadius:1 }} />
            {/* Body / dress */}
            <div style={{ position:"absolute", top:18, left:4, width:20, height:10, background:"#6366F1", borderRadius:"0 0 2px 2px" }} />
            {/* Necklace */}
            <div style={{ position:"absolute", top:19, left:12, width:4, height:2, background:"#FFD700", borderRadius:1 }} />
            {/* Legs */}
            <div style={{ position:"absolute", top:28, left:6, width:6, height:8, background:"#1a1a1a" }} />
            <div style={{ position:"absolute", top:28, left:16, width:6, height:8, background:"#1a1a1a" }} />
          </div>
        </div>
        {/* Game badge */}
            ...
            {item.file === "UIST_Logo.png" ? (
              <>
                ...
                <div style={{ width: "100%", height: "100%", position: "relative", overflow: "visible", pointerEvents: "none", userSelect: "none" }}>
                  ...
                  {/* Trophy + confetti — top-right corner of UIST logo */}
                  <div style={{
                    position: "absolute",
                    bottom: 72,
                    right: 0,
                  ...
                  <div style={{
                    ...
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src="/UIST_Logo.png" alt="UIST 2024 Best Paper Award" draggable={false}
                  ...
                  <div style={{
                    ...
                    UIST 2024 Best Paper<br />Belonging &amp; Inclusion (ACM)
                  </div>
                </div>
              </>
              ...
              <div className="relative" style={{ width: "100%", height: "100%" }}>
                <video
                  ref={videoRef}
                  src="/EmojiMovie797910679.mp4"
                  autoPlay
                  loop
                  muted
                  playsInline
                  aria-label="Jiho's animated avatar"
                  style={{
                    width: "100%",
                    height: "100%",
                    display: "block",
