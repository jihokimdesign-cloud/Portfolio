...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    right: "6rem",
    short:
      "Jiho redesigned our platform end-to-end. The 167% engagement lift wasn't luck, it was craft.",
    full:
      "Jiho joined us as a design intern and quickly became the backbone of our product redesign. His UX audit was thorough, his prototypes were polished, and his ability to run usability sessions and translate findings into actionable improvements was beyond what we expected. The numbers speak for themselves.",
  },
  {
