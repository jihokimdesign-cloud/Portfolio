      ...
      >
        ...
        >
          <div className="relative inline-block">
            <video
              ...
              aria-label="Jiho's animated avatar introducing himself"
              onEnded={() => {
        ...
        >
          <p className="font-mono text-sm text-neutral-500">
            {isRecruiterMode ? (
              <>Hi recruiter, I&apos;m <span className="text-neutral-900">Jiho</span></>
            ) : (
              <>Hii! I&apos;m <span className="text-neutral-900">Jiho</span></>
            )}
          </p>
        ...
        >
          I turn technical ambiguity and complex AI into experiences that feel effortless. Previously at a stealth AI startup, Lepal.ai, TAP3D, and Project Sidewalk. M.S. HCI+Design, University of Washington. ✦
        </motion.p>
          ...
          <div className="flex items-end gap-8">
            ...
            <div className="relative">
              <button
                ...
                aria-label="UIST 2024 Best Paper Award, tap for info"
              >
              ...
              <AnimatePresence>
                {tappedBadge === "microsoft" && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 -mt-12 w-52 pointer-events-none"
                    style={{ zIndex: 50 }}
                  >
                    ...
                    <div className="rounded-2xl bg-white px-3.5 py-2.5" style={{ border: "1px solid #e5e7eb" }}>
                      <p className="font-mono text-[11px] font-semibold leading-snug text-neutral-800">
                        🏆 UIST 2024 Best Paper
                      </p>
                      <p className="mt-0.5 font-mono text-[10px] leading-snug text-neutral-500">
                        Belonging &amp; Inclusion<br />Association for Computing Machinery (ACM)
                      </p>
                    </div>
                  </motion.div>
                )}
          ...
          >
            ...
            <div className="relative leading-snug">
              <span
                ...
                aria-hidden
              >
                How to Design XR Shopping Apps?
              </span>
